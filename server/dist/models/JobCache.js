...
const JobCacheSchema = new mongoose_1.Schema({
    queryKey: { type: String, required: true, unique: true, index: true },
    jobs: { type: [mongoose_1.Schema.Types.Mixed], required: true },
    fetchedAt: { type: Date, default: Date.now },
    ttlHours: { type: Number, default: 6 },
});
JobCacheSchema.index({ fetchedAt: 1 }, { expireAfterSeconds: 6 * 60 * 60 });
exports.default = mongoose_1.default.model("JobCache", JobCacheSchema);
